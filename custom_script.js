...
songTitles = ["Technicolour Portrait (demo)", "Snowden Ave", "Don't Wanna Be Right (instrumental)", "DOCTOR (instrumental)", "Daydream", "Stay", "Under the Sea (lofi cover)", "The Lucky One (prod. Nick Froelich)", "F E E L I N G I T ! !", "Get Over It", "Soulful Strut // Future Funk", "M8s, W8s, 808s (prod. Stu)", "Scandalous (with LoloPop13)", "just_killed_an_old_friend_but_make_it_lofi_hip_hop", "Final Project", "Car Freestyle (Instrumental)", "VIBE CA$H", "Yoshi", "Squad", "It's You", "Heat Lightning (Instrumental)"]
